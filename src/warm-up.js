...
var shouldOrderMore = 20
inStock < shouldOrderMore
...
var vegetables = ['carrots', 'onions', 'squash', 'eggplant', 'broccoli']
...
var fruits = ['apple', 'banana', 'orange', 'grape', 'kiwi', 'strawberry', 'pineapple']
...
var groceryStore = {
    name: 'Albertsons', 
    isOpen: true
    // items: {list of items whose values are the numbers in stock},
    // address: address
